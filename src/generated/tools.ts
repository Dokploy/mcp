...
// Generated from openapi.json on 2026-05-22
...
export const generatedTools: ToolDefinition[] = [
  ...
  },
  {
    ...
    method: "POST",
    path: "/libsql.create",
    schema: z.object({ "name": z.string().min(1), "appName": z.string().min(1), "dockerImage": z.string().default("ghcr.io/tursodatabase/libsql-server:v0.24.32"), "environmentId": z.string(), "description": z.union([z.string(), z.null()]), "databaseUser": z.string().min(1), "databasePassword": z.string(), "sqldNode": z.enum(["primary","replica"]), "sqldPrimaryUrl": z.union([z.union([z.string(), z.null()]), z.null()]), "enableNamespaces": z.boolean().default(false), "serverId": z.union([z.string(), z.null()]) }),
    annotations: {
      title: "Libsql Create",
      ...{"openWorldHint":true},
    },
  ...
  },
  {
    ...
    method: "POST",
    path: "/mariadb.create",
    schema: z.object({ "name": z.string().min(1), "appName": z.string().regex(new RegExp("^[a-zA-Z0-9._-]+$")).min(1).max(63).optional(), "dockerImage": z.string().default("mariadb:6"), "databaseRootPassword": z.string().optional(), "environmentId": z.string(), "description": z.union([z.string(), z.null()]).optional(), "databaseName": z.string().min(1), "databaseUser": z.string().min(1), "databasePassword": z.string(), "serverId": z.union([z.string(), z.null()]).optional() }),
    annotations: {
  ...
  },
  {
    ...
    schema: z.object({ "mariadbId": z.string().min(1), "password": z.string().min(1), "type": z.enum(["user","root"]).default("user") }),
    annotations: {
  ...
  },
  {
    ...
    method: "POST",
    path: "/mongo.create",
    schema: z.object({ "name": z.string().min(1), "appName": z.string().regex(new RegExp("^[a-zA-Z0-9._-]+$")).min(1).max(63).optional(), "dockerImage": z.string().default("mongo:15"), "environmentId": z.string(), "description": z.union([z.string(), z.null()]).optional(), "databaseUser": z.string().min(1), "databasePassword": z.string(), "serverId": z.union([z.string(), z.null()]).optional(), "replicaSets": z.union([z.boolean().default(false), z.null()]).optional() }),
    annotations: {
      title: "Mongo Create",
      ...{"openWorldHint":true},
    },
  ...
  },
  {
    ...
    schema: z.object({ "mongoId": z.string().min(1), "password": z.string().min(1) }),
    annotations: {
  ...
  },
  {
    ...
    method: "POST",
    path: "/mysql.create",
    schema: z.object({ "name": z.string().min(1), "appName": z.string().regex(new RegExp("^[a-zA-Z0-9._-]+$")).min(1).max(63).optional(), "dockerImage": z.string().default("mysql:8"), "environmentId": z.string(), "description": z.union([z.string(), z.null()]).optional(), "databaseName": z.string().min(1), "databaseUser": z.string().min(1), "databasePassword": z.string(), "databaseRootPassword": z.string().optional(), "serverId": z.union([z.string(), z.null()]).optional() }),
    annotations: {
      title: "Mysql Create",
      ...{"openWorldHint":true},
    },
  ...
  },
  {
    ...
    schema: z.object({ "mysqlId": z.string().min(1), "password": z.string().min(1), "type": z.enum(["user","root"]).default("user") }),
    annotations: {
  ...
  },
  {
    ...
    schema: z.object({ "name": z.string().min(1), "appName": z.string().regex(new RegExp("^[a-zA-Z0-9._-]+$")).min(1).max(63).optional(), "databaseName": z.string().min(1), "databaseUser": z.string().min(1), "databasePassword": z.string(), "dockerImage": z.string().default("postgres:18"), "environmentId": z.string(), "description": z.union([z.string(), z.null()]).optional(), "serverId": z.union([z.string(), z.null()]).optional() }),
    annotations: {
  ...
  },
  {
    ...
    schema: z.object({ "postgresId": z.string().min(1), "password": z.string().min(1) }),
    annotations: {
  ...
  },
  {
    ...
    schema: z.object({ "redisId": z.string().min(1), "password": z.string().min(1) }),
    annotations: {
